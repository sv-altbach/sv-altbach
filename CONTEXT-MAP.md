...
- **Local ports:** Club website `3000`, Masters `3001` (wired via env, e.g. `VITE_MASTERS_URL`), Club email preview `3002`.
- **Club stack:** TanStack Start (Vite 8 + Nitro). Masters remains on Next. See ADR-0003.
