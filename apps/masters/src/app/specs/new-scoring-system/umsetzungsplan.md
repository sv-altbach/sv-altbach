...
- Die produktiven Turnier-JSON-Dateien bleiben im bestehenden Datenordner `apps/masters/src/app/scoreboard/database`.
- Die Dateinamen folgen weiterhin dem Muster `tournament_1.json`, `tournament_2.json` usw.
- Das kuenftige Dateiformat entspricht `apps/masters/src/app/specs/new-scoring-system/json-example-stripped.json`.
...
Die aktuelle Implementierung kann bereits eine unbekannte Anzahl Dateien lesen, filtert aber auf Dateinamen mit `tournament`. Diese Konvention wird beibehalten: Die produktiven Dateien liegen weiterhin unter `apps/masters/src/app/scoreboard/database` und heissen `tournament_1.json`, `tournament_2.json` usw.
...
Betroffene bestehende Stelle: `apps/masters/src/app/scoreboard/utils/getTournamentResults.ts`.
...
Betroffene bestehende Stelle: `apps/masters/src/app/scoreboard/utils/sortPlayers.ts`.
...
- `apps/masters/src/app/scoreboard/utils/playerUtils.ts`
- `apps/masters/src/app/scoreboard/components/table-row.tsx`
- `apps/masters/src/app/scoreboard/components/table-body.tsx`
...
- `apps/masters/src/app/scoreboard/components/table-head.tsx`
- `apps/masters/src/app/scoreboard/components/table-row.tsx`
- `apps/masters/src/app/scoreboard/components/table-body.tsx`
- `apps/masters/src/app/scoreboard/components/Table.tsx`
