...
import { ListOfAttendeesLink } from "@/app/tournaments/components/list-of-attendees-link";
import { PointRules } from "@/app/tournaments/components/point-rules";
import { Prizes } from "@/app/tournaments/components/prizes";
import { RegisterButton } from "@/app/tournaments/components/register-button";
			...
			<Table.Root>
				<Table.Body>
					<Table.Row>
						...
						<Table.Cell>
							{tournament.date ?? "Datum wird bald bekanntgegeben."}
						</Table.Cell>
					</Table.Row>
					...
					<Table.Row>
						...
						<Table.Cell>
							{tournament.startTime ?? "Uhrzeit wird bald bekanntgegeben."}
						</Table.Cell>
					</Table.Row>
					...
					<Table.Row>
						...
						<Table.Cell>
							{tournament.endTime ?? "Uhrzeit wird bald bekanntgegeben."}
						</Table.Cell>
					</Table.Row>
					...
					<Table.Row>
						...
						<Table.Cell>
							{tournament.mode ?? "Turniermodus wird bald bekanntgegeben."}
						</Table.Cell>
					</Table.Row>
					...
					<Table.Row>
						...
						<Table.Cell>
							{tournament.evaluation ?? "Auswertung wird bald bekanntgegeben"}
						</Table.Cell>
					</Table.Row>
