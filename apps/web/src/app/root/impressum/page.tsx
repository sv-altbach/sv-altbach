				...
				<section className="py-20">
					<div className="container mx-auto px-4">
						<div className="mx-auto max-w-4xl">
							...
							<p className="mb-1">
								<span className="font-semibold text-primary">Telefon:</span> +49
								(0) 1520 9186437
							</p>
							<p className="mb-6">
							...
							<ul className="mb-6 list-inside list-disc space-y-1">
								<li>
									1. Vorsitzender: Alexander Hande, Drosselweg 30, 70734
									Fellbach, 01520-9186437, am2702 (ät) aol.com
								</li>
								<li>
							...
							<p className="mb-4">
								...
								<br />
								Inhaltlich verantwortlich i.S.v. § 55 Abs. 2 RStV: Hande,
								Alexander, Drosselweg 30, 70734 Fellbach
								<br />
								<br />
