			...
			<div className="container mx-auto px-4">
				<div className="mx-auto prose prose-lg max-w-4xl">
					...
					<p>
						...
						informieren wir Sie nachfolgend über die von uns zu Optimierungszwecken
						sowie zur Steigerung der Nutzungsqualität eingesetzten Fremdkomponenten,
					...
					<p>
						...
						bzw. an unseren Webspace-Provider übermittelt. Mit diesen sog.
					...
					<p>
						Nehmen Sie über unser Kontaktformular oder per E-Mail Kontakt zu uns auf,
						verarbeiten wir die von Ihnen angegebenen Daten (insbesondere Name,
						E-Mail-Adresse, Betreff und Nachricht) sowie die für den Versand der E-Mail
						erforderlichen technischen Informationen beim Dienstleister.
					</p>
					<p>
						Zwecke sind die Entgegennahme und Bearbeitung Ihrer Anfrage sowie – sofern
						Sie das Kontaktformular nutzen – der Versand einer Bestätigungsnachricht an
						Ihre E-Mail-Adresse.
					</p>
					<p>
						Empfänger sind die beim Verantwortlichen mit der Bearbeitung betroffenen
						Personen. Zum Versand und zur Zustellung der E-Mails beauftragen wir die
						Plus Five Five, Inc. (Betreiberin des Dienstes „Resend“), mit Sitz in den
						USA („Resend“), als Auftragsverarbeiter. Mit Resend besteht ei
						Datenübermittlung in die USA erfolgen. Angemebilden Dabei kann eine das
						Angemessenheitsbeschlussverfahren gemäß Art. 4 Garantien bilden
						(EU-US-Datenrahmen, Data Privacy Framework) sowie –t DSGVO erforderlich –
						die in der Auftragsverarbeitungsvereinbarung von Resend vereinbarten
					...
					<p>
						Rechtsgrundlage für Anfragen, die der Anbahnung oder Durchführung eines
						Vertragsverhältnisses mit uns dienen, ist Art. 6 Abs. 1 lit. b) DSGVO. Für
						sonstige Anfragen ist Rechtsgrundlage Art. 6 Abs. 1 lit b) f DSGVO; unser
						berechtigtes Interesse liegt in der Beantwortun lit. Ihrer Kontaktaufnahme
						und der zuverlässigen Bereitstellung des Kommunikationswegs. Soweit die
						Übermittlung in die USA auf unser Auftragsverarbeitungsverhältnis mit Resend
						gestützt wird, kann zusätzlich Art. 28 DSGVO in Verbindung mit den
						Schutzklauseln gemäß Art. 46 Abs. 2 lit. c DSGVO bzw. Art. 45 DSGVO (Data
						Privacy Framework) einschlägig sein.
					</p>
					<p>
						Die Angabe Ihrer Daten ist weder gesetzlich noch vertraglich vorgeschrieben.
						Ohne die für die jeweilige Kontaktaufnahme nötigen Angaben können wir Ihre
						Anfrage jedoch nicht bearbeiten. Es erfolgt keine automatisierte
						Entscheidungsfindung einschließlich Profiling.
					</p>
					<p>
						Wir löschen Ihre in diesem Zusammenhang verarbeiteten Daten, sobald die
						Anfrage abschließend erledigt ist und keine gesetzlichen
						Aufbewahrungspflichten entgegenstehen (z. B. bei anschließender
						Vertragsbeziehung). Sofern keine Aufbewahrungspflichten bestehen, werden
						Kontaktanfragen in der Regel spätestens 12 Monate nach abschließender
